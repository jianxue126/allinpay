...
public class SybLogonTrans extends BaseTrans {
	...
	public IISO8583Packet getSendPacket() {
		...
		sendPacked.setField(IISO8583Packet._FLD60_, "50" + getBatch() + "003");
		sendPacked.setField(IISO8583Packet._FLD63_, "01"+String.format("%61s", "0")+"0"+"0000"+"0000");
		return sendPacked;
	}
